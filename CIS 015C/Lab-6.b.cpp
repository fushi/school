...
int main(){
    ...
    FHhashQPwFind<EBookEntry> hash_table;
    ...
    for (int l = 0; l < RAND_NUM; l++) {
        try{
            ...
            query.SetNEtextNum(book_input[random_indices[l]].GetNEtextNum());
            //            query.SetSCreator(book_input[random_indices[l]].GetSCreator());
            
            book = hash_table.find(query);
    ...
    try{
        query.SetNEtextNum(1);
        //        query.SetSCreator("Jack Kerouac");
